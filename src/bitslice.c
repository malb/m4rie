...
/*     size_t j, j2; */
/*     for(j=0, j2=0; j<A->x->ncols; j+=2, j2++) { */
/*       mzd_write_bit(A->x, i, j, mzd_read_bit(A0,i,j2)); */
/*       mzd_write_bit(A->x, i, j+1, mzd_read_bit(A1,i,j2)); */
/*     } */
/*   } */
/* } */
...
void mzed_pack2(mzed_t *A, const mzd_t *A0, const mzd_t *A1) {
  for(size_t i=0; i<A->nrows; i++) {
    ...
    size_t j = 0;
    size_t j2 = 0;
    for(j=0; j+2 < A->x->width; j+=2) {
      j2 = j/2;

      register word aw0 = a[j+0];
      register word aw1 = a[j+1];
    ...
    if(j+2 == A->x->width) { 
      /* we have to deal with two words */
      j2 = j/2;
      /* A0 first word */
      ...
      j2 = j/2;
      switch((2*A->ncols) % RADIX) {
      case  0:      a[j] |= (a0[j2] & ONE<<(RADIX - 31 - 1))>>31;
      case 62:      a[j] |= (a0[j2] & ONE<<(RADIX - 30 - 1))>>30;
      case 60:      a[j] |= (a0[j2] & ONE<<(RADIX - 29 - 1))>>29;
      case 58:      a[j] |= (a0[j2] & ONE<<(RADIX - 28 - 1))>>28;
      case 56:      a[j] |= (a0[j2] & ONE<<(RADIX - 27 - 1))>>27;
      case 54:      a[j] |= (a0[j2] & ONE<<(RADIX - 26 - 1))>>26;
      case 52:      a[j] |= (a0[j2] & ONE<<(RADIX - 25 - 1))>>25;
      case 50:      a[j] |= (a0[j2] & ONE<<(RADIX - 24 - 1))>>24;
      case 48:      a[j] |= (a0[j2] & ONE<<(RADIX - 23 - 1))>>23;
      case 46:      a[j] |= (a0[j2] & ONE<<(RADIX - 22 - 1))>>22;
      case 44:      a[j] |= (a0[j2] & ONE<<(RADIX - 21 - 1))>>21;
      case 42:      a[j] |= (a0[j2] & ONE<<(RADIX - 20 - 1))>>20;
      case 40:      a[j] |= (a0[j2] & ONE<<(RADIX - 19 - 1))>>19;
      case 38:      a[j] |= (a0[j2] & ONE<<(RADIX - 18 - 1))>>18;
      case 36:      a[j] |= (a0[j2] & ONE<<(RADIX - 17 - 1))>>17;
      case 34:      a[j] |= (a0[j2] & ONE<<(RADIX - 16 - 1))>>16;
      case 32:      a[j] |= (a0[j2] & ONE<<(RADIX - 15 - 1))>>15;
      case 30:      a[j] |= (a0[j2] & ONE<<(RADIX - 14 - 1))>>14;
      case 28:      a[j] |= (a0[j2] & ONE<<(RADIX - 13 - 1))>>13;
      case 26:      a[j] |= (a0[j2] & ONE<<(RADIX - 12 - 1))>>12;
      case 24:      a[j] |= (a0[j2] & ONE<<(RADIX - 11 - 1))>>11;
      case 22:      a[j] |= (a0[j2] & ONE<<(RADIX - 10 - 1))>>10;
      case 20:      a[j] |= (a0[j2] & ONE<<(RADIX -  9 - 1))>> 9;
      case 18:      a[j] |= (a0[j2] & ONE<<(RADIX -  8 - 1))>> 8;
      case 16:      a[j] |= (a0[j2] & ONE<<(RADIX -  7 - 1))>> 7;
      case 14:      a[j] |= (a0[j2] & ONE<<(RADIX -  6 - 1))>> 6;
      case 12:      a[j] |= (a0[j2] & ONE<<(RADIX -  5 - 1))>> 5;
      case 10:      a[j] |= (a0[j2] & ONE<<(RADIX -  4 - 1))>> 4;
      case  8:      a[j] |= (a0[j2] & ONE<<(RADIX -  3 - 1))>> 3;
      case  6:      a[j] |= (a0[j2] & ONE<<(RADIX -  2 - 1))>> 2;
      case  4:      a[j] |= (a0[j2] & ONE<<(RADIX -  1 - 1))>> 1;
      case  2:      a[j] |= (a0[j2] & ONE<<(RADIX -  0 - 1))>> 0;
      }

      switch((2*A->ncols) % RADIX) {
      case  0:      a[j] |= (a1[j2] & ONE<<(RADIX - 31 - 1))>>32;
      case 62:      a[j] |= (a1[j2] & ONE<<(RADIX - 30 - 1))>>31;
      case 60:      a[j] |= (a1[j2] & ONE<<(RADIX - 29 - 1))>>30;
      case 58:      a[j] |= (a1[j2] & ONE<<(RADIX - 28 - 1))>>29;
      case 56:      a[j] |= (a1[j2] & ONE<<(RADIX - 27 - 1))>>28;
      case 54:      a[j] |= (a1[j2] & ONE<<(RADIX - 26 - 1))>>27;
      case 52:      a[j] |= (a1[j2] & ONE<<(RADIX - 25 - 1))>>26;
      case 50:      a[j] |= (a1[j2] & ONE<<(RADIX - 24 - 1))>>25;
      case 48:      a[j] |= (a1[j2] & ONE<<(RADIX - 23 - 1))>>24;
      case 46:      a[j] |= (a1[j2] & ONE<<(RADIX - 22 - 1))>>23;
      case 44:      a[j] |= (a1[j2] & ONE<<(RADIX - 21 - 1))>>22;
      case 42:      a[j] |= (a1[j2] & ONE<<(RADIX - 20 - 1))>>21;
      case 40:      a[j] |= (a1[j2] & ONE<<(RADIX - 19 - 1))>>20;
      case 38:      a[j] |= (a1[j2] & ONE<<(RADIX - 18 - 1))>>19;
      case 36:      a[j] |= (a1[j2] & ONE<<(RADIX - 17 - 1))>>18;
      case 34:      a[j] |= (a1[j2] & ONE<<(RADIX - 16 - 1))>>17;
      case 32:      a[j] |= (a1[j2] & ONE<<(RADIX - 15 - 1))>>16;
      case 30:      a[j] |= (a1[j2] & ONE<<(RADIX - 14 - 1))>>15;
      case 28:      a[j] |= (a1[j2] & ONE<<(RADIX - 13 - 1))>>14;
      case 26:      a[j] |= (a1[j2] & ONE<<(RADIX - 12 - 1))>>13;
      case 24:      a[j] |= (a1[j2] & ONE<<(RADIX - 11 - 1))>>12;
      case 22:      a[j] |= (a1[j2] & ONE<<(RADIX - 10 - 1))>>11;
      case 20:      a[j] |= (a1[j2] & ONE<<(RADIX -  9 - 1))>>10;
      case 18:      a[j] |= (a1[j2] & ONE<<(RADIX -  8 - 1))>> 9;
      case 16:      a[j] |= (a1[j2] & ONE<<(RADIX -  7 - 1))>> 8;
      case 14:      a[j] |= (a1[j2] & ONE<<(RADIX -  6 - 1))>> 7;
      case 12:      a[j] |= (a1[j2] & ONE<<(RADIX -  5 - 1))>> 6;
      case 10:      a[j] |= (a1[j2] & ONE<<(RADIX -  4 - 1))>> 5;
      case  8:      a[j] |= (a1[j2] & ONE<<(RADIX -  3 - 1))>> 4;
      case  6:      a[j] |= (a1[j2] & ONE<<(RADIX -  2 - 1))>> 3;
      case  4:      a[j] |= (a1[j2] & ONE<<(RADIX -  1 - 1))>> 2;
      case  2:      a[j] |= (a1[j2] & ONE<<(RADIX -  0 - 1))>> 1;
      }
    }
  }
}
...
void mzed_unpack2(mzd_t *A0, mzd_t *A1, const mzed_t *A) {
  for(size_t i=0; i<A->nrows; i++) {
    ...
    for(j=0; j+2 < A->x->width; j+=2) {
      ...
      register word tmp0 = 0;
      register word tmp1 = 0;
      register word aw0 = a[j+0];
      register word aw1 = a[j+1];
      
      /* A0 first word */
      tmp0 |= (aw0 & ONE<<(RADIX -  0 - 1))<< 0;    tmp1 |= (aw0 & ONE<<(RADIX -  0 - 2))<< 1;
      tmp0 |= (aw0 & ONE<<(RADIX -  2 - 1))<< 1;    tmp1 |= (aw0 & ONE<<(RADIX -  2 - 2))<< 2;
      tmp0 |= (aw0 & ONE<<(RADIX -  4 - 1))<< 2;    tmp1 |= (aw0 & ONE<<(RADIX -  4 - 2))<< 3;
      tmp0 |= (aw0 & ONE<<(RADIX -  6 - 1))<< 3;    tmp1 |= (aw0 & ONE<<(RADIX -  6 - 2))<< 4;
      tmp0 |= (aw0 & ONE<<(RADIX -  8 - 1))<< 4;    tmp1 |= (aw0 & ONE<<(RADIX -  8 - 2))<< 5;
      tmp0 |= (aw0 & ONE<<(RADIX - 10 - 1))<< 5;    tmp1 |= (aw0 & ONE<<(RADIX - 10 - 2))<< 6;
      tmp0 |= (aw0 & ONE<<(RADIX - 12 - 1))<< 6;    tmp1 |= (aw0 & ONE<<(RADIX - 12 - 2))<< 7;
      tmp0 |= (aw0 & ONE<<(RADIX - 14 - 1))<< 7;    tmp1 |= (aw0 & ONE<<(RADIX - 14 - 2))<< 8;
      tmp0 |= (aw0 & ONE<<(RADIX - 16 - 1))<< 8;    tmp1 |= (aw0 & ONE<<(RADIX - 16 - 2))<< 9;
      tmp0 |= (aw0 & ONE<<(RADIX - 18 - 1))<< 9;    tmp1 |= (aw0 & ONE<<(RADIX - 18 - 2))<<10;
      tmp0 |= (aw0 & ONE<<(RADIX - 20 - 1))<<10;    tmp1 |= (aw0 & ONE<<(RADIX - 20 - 2))<<11;
      tmp0 |= (aw0 & ONE<<(RADIX - 22 - 1))<<11;    tmp1 |= (aw0 & ONE<<(RADIX - 22 - 2))<<12;
      tmp0 |= (aw0 & ONE<<(RADIX - 24 - 1))<<12;    tmp1 |= (aw0 & ONE<<(RADIX - 24 - 2))<<13;
      tmp0 |= (aw0 & ONE<<(RADIX - 26 - 1))<<13;    tmp1 |= (aw0 & ONE<<(RADIX - 26 - 2))<<14;
      tmp0 |= (aw0 & ONE<<(RADIX - 28 - 1))<<14;    tmp1 |= (aw0 & ONE<<(RADIX - 28 - 2))<<15;
      tmp0 |= (aw0 & ONE<<(RADIX - 30 - 1))<<15;    tmp1 |= (aw0 & ONE<<(RADIX - 30 - 2))<<16;
      tmp0 |= (aw0 & ONE<<(RADIX - 32 - 1))<<16;    tmp1 |= (aw0 & ONE<<(RADIX - 32 - 2))<<17;
      tmp0 |= (aw0 & ONE<<(RADIX - 34 - 1))<<17;    tmp1 |= (aw0 & ONE<<(RADIX - 34 - 2))<<18;
      tmp0 |= (aw0 & ONE<<(RADIX - 36 - 1))<<18;    tmp1 |= (aw0 & ONE<<(RADIX - 36 - 2))<<19;
      tmp0 |= (aw0 & ONE<<(RADIX - 38 - 1))<<19;    tmp1 |= (aw0 & ONE<<(RADIX - 38 - 2))<<20;
      tmp0 |= (aw0 & ONE<<(RADIX - 40 - 1))<<20;    tmp1 |= (aw0 & ONE<<(RADIX - 40 - 2))<<21;
      tmp0 |= (aw0 & ONE<<(RADIX - 42 - 1))<<21;    tmp1 |= (aw0 & ONE<<(RADIX - 42 - 2))<<22;
      tmp0 |= (aw0 & ONE<<(RADIX - 44 - 1))<<22;    tmp1 |= (aw0 & ONE<<(RADIX - 44 - 2))<<23;
      tmp0 |= (aw0 & ONE<<(RADIX - 46 - 1))<<23;    tmp1 |= (aw0 & ONE<<(RADIX - 46 - 2))<<24;
      tmp0 |= (aw0 & ONE<<(RADIX - 48 - 1))<<24;    tmp1 |= (aw0 & ONE<<(RADIX - 48 - 2))<<25;
      tmp0 |= (aw0 & ONE<<(RADIX - 50 - 1))<<25;    tmp1 |= (aw0 & ONE<<(RADIX - 50 - 2))<<26;
      tmp0 |= (aw0 & ONE<<(RADIX - 52 - 1))<<26;    tmp1 |= (aw0 & ONE<<(RADIX - 52 - 2))<<27;
      tmp0 |= (aw0 & ONE<<(RADIX - 54 - 1))<<27;    tmp1 |= (aw0 & ONE<<(RADIX - 54 - 2))<<28;
      tmp0 |= (aw0 & ONE<<(RADIX - 56 - 1))<<28;    tmp1 |= (aw0 & ONE<<(RADIX - 56 - 2))<<29;
      tmp0 |= (aw0 & ONE<<(RADIX - 58 - 1))<<29;    tmp1 |= (aw0 & ONE<<(RADIX - 58 - 2))<<30;
      tmp0 |= (aw0 & ONE<<(RADIX - 60 - 1))<<30;    tmp1 |= (aw0 & ONE<<(RADIX - 60 - 2))<<31;
      tmp0 |= (aw0 & ONE<<(RADIX - 62 - 1))<<31;    tmp1 |= (aw0 & ONE<<(RADIX - 62 - 2))<<32;

      /* A1 */
      tmp0 |= (aw1 & ONE<<(RADIX -  0 - 1))>>32;    tmp1 |= (aw1 & (ONE<<(RADIX -  0 - 2)))>>31;
      tmp0 |= (aw1 & ONE<<(RADIX -  2 - 1))>>31;    tmp1 |= (aw1 & (ONE<<(RADIX -  2 - 2)))>>30;
      tmp0 |= (aw1 & ONE<<(RADIX -  4 - 1))>>30;    tmp1 |= (aw1 & (ONE<<(RADIX -  4 - 2)))>>29;
      tmp0 |= (aw1 & ONE<<(RADIX -  6 - 1))>>29;    tmp1 |= (aw1 & (ONE<<(RADIX -  6 - 2)))>>28;
      tmp0 |= (aw1 & ONE<<(RADIX -  8 - 1))>>28;    tmp1 |= (aw1 & (ONE<<(RADIX -  8 - 2)))>>27;
      tmp0 |= (aw1 & ONE<<(RADIX - 10 - 1))>>27;    tmp1 |= (aw1 & (ONE<<(RADIX - 10 - 2)))>>26;
      tmp0 |= (aw1 & ONE<<(RADIX - 12 - 1))>>26;    tmp1 |= (aw1 & (ONE<<(RADIX - 12 - 2)))>>25;
      tmp0 |= (aw1 & ONE<<(RADIX - 14 - 1))>>25;    tmp1 |= (aw1 & (ONE<<(RADIX - 14 - 2)))>>24;
      tmp0 |= (aw1 & ONE<<(RADIX - 16 - 1))>>24;    tmp1 |= (aw1 & (ONE<<(RADIX - 16 - 2)))>>23;
      tmp0 |= (aw1 & ONE<<(RADIX - 18 - 1))>>23;    tmp1 |= (aw1 & (ONE<<(RADIX - 18 - 2)))>>22;
      tmp0 |= (aw1 & ONE<<(RADIX - 20 - 1))>>22;    tmp1 |= (aw1 & (ONE<<(RADIX - 20 - 2)))>>21;
      tmp0 |= (aw1 & ONE<<(RADIX - 22 - 1))>>21;    tmp1 |= (aw1 & (ONE<<(RADIX - 22 - 2)))>>20;
      tmp0 |= (aw1 & ONE<<(RADIX - 24 - 1))>>20;    tmp1 |= (aw1 & (ONE<<(RADIX - 24 - 2)))>>19;
      tmp0 |= (aw1 & ONE<<(RADIX - 26 - 1))>>19;    tmp1 |= (aw1 & (ONE<<(RADIX - 26 - 2)))>>18;
      tmp0 |= (aw1 & ONE<<(RADIX - 28 - 1))>>18;    tmp1 |= (aw1 & (ONE<<(RADIX - 28 - 2)))>>17;
      tmp0 |= (aw1 & ONE<<(RADIX - 30 - 1))>>17;    tmp1 |= (aw1 & (ONE<<(RADIX - 30 - 2)))>>16;
      tmp0 |= (aw1 & ONE<<(RADIX - 32 - 1))>>16;    tmp1 |= (aw1 & (ONE<<(RADIX - 32 - 2)))>>15;
      tmp0 |= (aw1 & ONE<<(RADIX - 34 - 1))>>15;    tmp1 |= (aw1 & (ONE<<(RADIX - 34 - 2)))>>14;
      tmp0 |= (aw1 & ONE<<(RADIX - 36 - 1))>>14;    tmp1 |= (aw1 & (ONE<<(RADIX - 36 - 2)))>>13;
      tmp0 |= (aw1 & ONE<<(RADIX - 38 - 1))>>13;    tmp1 |= (aw1 & (ONE<<(RADIX - 38 - 2)))>>12;
      tmp0 |= (aw1 & ONE<<(RADIX - 40 - 1))>>12;    tmp1 |= (aw1 & (ONE<<(RADIX - 40 - 2)))>>11;
      tmp0 |= (aw1 & ONE<<(RADIX - 42 - 1))>>11;    tmp1 |= (aw1 & (ONE<<(RADIX - 42 - 2)))>>10;
      tmp0 |= (aw1 & ONE<<(RADIX - 44 - 1))>>10;    tmp1 |= (aw1 & (ONE<<(RADIX - 44 - 2)))>> 9;
      tmp0 |= (aw1 & ONE<<(RADIX - 46 - 1))>> 9;    tmp1 |= (aw1 & (ONE<<(RADIX - 46 - 2)))>> 8;
      tmp0 |= (aw1 & ONE<<(RADIX - 48 - 1))>> 8;    tmp1 |= (aw1 & (ONE<<(RADIX - 48 - 2)))>> 7;
      tmp0 |= (aw1 & ONE<<(RADIX - 50 - 1))>> 7;    tmp1 |= (aw1 & (ONE<<(RADIX - 50 - 2)))>> 6;
      tmp0 |= (aw1 & ONE<<(RADIX - 52 - 1))>> 6;    tmp1 |= (aw1 & (ONE<<(RADIX - 52 - 2)))>> 5;
      tmp0 |= (aw1 & ONE<<(RADIX - 54 - 1))>> 5;    tmp1 |= (aw1 & (ONE<<(RADIX - 54 - 2)))>> 4;
      tmp0 |= (aw1 & ONE<<(RADIX - 56 - 1))>> 4;    tmp1 |= (aw1 & (ONE<<(RADIX - 56 - 2)))>> 3;
      tmp0 |= (aw1 & ONE<<(RADIX - 58 - 1))>> 3;    tmp1 |= (aw1 & (ONE<<(RADIX - 58 - 2)))>> 2;
      tmp0 |= (aw1 & ONE<<(RADIX - 60 - 1))>> 2;    tmp1 |= (aw1 & (ONE<<(RADIX - 60 - 2)))>> 1;
      tmp0 |= (aw1 & ONE<<(RADIX - 62 - 1))>> 1;    tmp1 |= (aw1 & (ONE<<(RADIX - 62 - 2)))>> 0;
    ...
    if(j+2 == A->x->width) { 
      ...
      /* we have to deal with two words */
      j2 = j/2;     
      tmp0 |= (a[j] & ONE<<(RADIX -  0 - 1))<< 0;
      tmp0 |= (a[j] & ONE<<(RADIX -  2 - 1))<< 1;
      tmp0 |= (a[j] & ONE<<(RADIX -  4 - 1))<< 2;
      tmp0 |= (a[j] & ONE<<(RADIX -  6 - 1))<< 3;
      tmp0 |= (a[j] & ONE<<(RADIX -  8 - 1))<< 4;
      tmp0 |= (a[j] & ONE<<(RADIX - 10 - 1))<< 5;
      tmp0 |= (a[j] & ONE<<(RADIX - 12 - 1))<< 6;
      tmp0 |= (a[j] & ONE<<(RADIX - 14 - 1))<< 7;
      tmp0 |= (a[j] & ONE<<(RADIX - 16 - 1))<< 8;
      tmp0 |= (a[j] & ONE<<(RADIX - 18 - 1))<< 9;
      tmp0 |= (a[j] & ONE<<(RADIX - 20 - 1))<<10;
      tmp0 |= (a[j] & ONE<<(RADIX - 22 - 1))<<11;
      tmp0 |= (a[j] & ONE<<(RADIX - 24 - 1))<<12;
      tmp0 |= (a[j] & ONE<<(RADIX - 26 - 1))<<13;
      tmp0 |= (a[j] & ONE<<(RADIX - 28 - 1))<<14;
      tmp0 |= (a[j] & ONE<<(RADIX - 30 - 1))<<15;
      tmp0 |= (a[j] & ONE<<(RADIX - 32 - 1))<<16;
      tmp0 |= (a[j] & ONE<<(RADIX - 34 - 1))<<17;
      tmp0 |= (a[j] & ONE<<(RADIX - 36 - 1))<<18;
      tmp0 |= (a[j] & ONE<<(RADIX - 38 - 1))<<19;
      tmp0 |= (a[j] & ONE<<(RADIX - 40 - 1))<<20;
      tmp0 |= (a[j] & ONE<<(RADIX - 42 - 1))<<21;
      tmp0 |= (a[j] & ONE<<(RADIX - 44 - 1))<<22;
      tmp0 |= (a[j] & ONE<<(RADIX - 46 - 1))<<23;
      tmp0 |= (a[j] & ONE<<(RADIX - 48 - 1))<<24;
      tmp0 |= (a[j] & ONE<<(RADIX - 50 - 1))<<25;
      tmp0 |= (a[j] & ONE<<(RADIX - 52 - 1))<<26;
      tmp0 |= (a[j] & ONE<<(RADIX - 54 - 1))<<27;
      tmp0 |= (a[j] & ONE<<(RADIX - 56 - 1))<<28;
      tmp0 |= (a[j] & ONE<<(RADIX - 58 - 1))<<29;
      tmp0 |= (a[j] & ONE<<(RADIX - 60 - 1))<<30;
      tmp0 |= (a[j] & ONE<<(RADIX - 62 - 1))<<31;
      a0[j2] = tmp0;

      register word tmp1 = 0;
      tmp1 |= (a[j] & ONE<<(RADIX -  0 - 2))<< 1;
      tmp1 |= (a[j] & ONE<<(RADIX -  2 - 2))<< 2;
      tmp1 |= (a[j] & ONE<<(RADIX -  4 - 2))<< 3;
      tmp1 |= (a[j] & ONE<<(RADIX -  6 - 2))<< 4;
      tmp1 |= (a[j] & ONE<<(RADIX -  8 - 2))<< 5;
      tmp1 |= (a[j] & ONE<<(RADIX - 10 - 2))<< 6;
      tmp1 |= (a[j] & ONE<<(RADIX - 12 - 2))<< 7;
      tmp1 |= (a[j] & ONE<<(RADIX - 14 - 2))<< 8;
      tmp1 |= (a[j] & ONE<<(RADIX - 16 - 2))<< 9;
      tmp1 |= (a[j] & ONE<<(RADIX - 18 - 2))<<10;
      tmp1 |= (a[j] & ONE<<(RADIX - 20 - 2))<<11;
      tmp1 |= (a[j] & ONE<<(RADIX - 22 - 2))<<12;
      tmp1 |= (a[j] & ONE<<(RADIX - 24 - 2))<<13;
      tmp1 |= (a[j] & ONE<<(RADIX - 26 - 2))<<14;
      tmp1 |= (a[j] & ONE<<(RADIX - 28 - 2))<<15;
      tmp1 |= (a[j] & ONE<<(RADIX - 30 - 2))<<16;
      tmp1 |= (a[j] & ONE<<(RADIX - 32 - 2))<<17;
      tmp1 |= (a[j] & ONE<<(RADIX - 34 - 2))<<18;
      tmp1 |= (a[j] & ONE<<(RADIX - 36 - 2))<<19;
      tmp1 |= (a[j] & ONE<<(RADIX - 38 - 2))<<20;
      tmp1 |= (a[j] & ONE<<(RADIX - 40 - 2))<<21;
      tmp1 |= (a[j] & ONE<<(RADIX - 42 - 2))<<22;
      tmp1 |= (a[j] & ONE<<(RADIX - 44 - 2))<<23;
      tmp1 |= (a[j] & ONE<<(RADIX - 46 - 2))<<24;
      tmp1 |= (a[j] & ONE<<(RADIX - 48 - 2))<<25;
      tmp1 |= (a[j] & ONE<<(RADIX - 50 - 2))<<26;
      tmp1 |= (a[j] & ONE<<(RADIX - 52 - 2))<<27;
      tmp1 |= (a[j] & ONE<<(RADIX - 54 - 2))<<28;
      tmp1 |= (a[j] & ONE<<(RADIX - 56 - 2))<<29;
      tmp1 |= (a[j] & ONE<<(RADIX - 58 - 2))<<30;
      tmp1 |= (a[j] & ONE<<(RADIX - 60 - 2))<<31;
      tmp1 |= (a[j] & ONE<<(RADIX - 62 - 2))<<32;
      a1[j2] = tmp1;
