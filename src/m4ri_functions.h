static inline word __mzd_read_bits(const mzd_t *a, const size_t x, const size_t y, const size_t n) {
...
static inline void __mzd_xor_bits(const mzd_t *a, const size_t x, const size_t y, const size_t n, word values) {
